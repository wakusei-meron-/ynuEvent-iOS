...
@interface GIPostEventViewController ()

@end

@implementation GIPostEventViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        //バーにボタン追加
//        UIBarButtonItem *btnRegister = [[UIBarButtonItem alloc] initWithTitle:@"次へ"
...
- (IBAction)backToEventList:(id)sender {
...
- (void)getDateFromViewController:(NSDate *)date
{
    ...
    cDate = (GITableViewCell *)[self.mainTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:0]];
...
//            }];
    ...
    if (indexPath.section == 1) {
        ...
        //セルの値の取得
        cGName = (GITableViewCell *)[self.mainTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]];
        cTitle = (GITableViewCell *)[self.mainTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:3 inSection:0]];
        cSpot  = (GITableViewCell *)[self.mainTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:2 inSection:0]];
        cBody  = (GITableViewCell *)[self.mainTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:4 inSection:0]];
